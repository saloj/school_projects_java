...
/**
 * Experiment - String concatenation (80-char strings)
 */
public class StringConcatLargeMain {

    public static void main(String[] args) {
        String testString = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZab";
        String testFinal = "";
        int numOfIterations = 13900;
        ...
        System.out.println("======================================================================");
        System.out.println("Result of concatenation experiment (10 runs) - adding 80 char strings");
        System.out.println("======================================================================");
